...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* <h3 style={{textAlign: 'center'}}>Danh sách tất cả sản phẩm</h3>
      ...
      {/* <h3 style={{textAlign: 'center'}}>Danh sách sản phẩm nam</h3>
      <div className='product-container'>
        {
          products.filter(product => product.type === 'MEN').map((product) => {
            return (
              <Product
                key={product.id}
                productImg={product.productImg}
      ...
      <h3 style={{textAlign: 'center'}}>Danh sách sản phẩm nữ</h3>
      <div className='product-container'>
        {
          products.filter(product => product.type === 'WOMEN').map((product) => {
            return (
              <Product
                key={product.id}
                productImg={product.productImg}
